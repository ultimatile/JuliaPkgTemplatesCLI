...
class JuliaPackageGenerator:
    ...
    def create_package(
        ...
        plugins = self._get_plugins(template, license_type, with_docs, with_ci, with_codecov)
    ...
    def _call_julia_generator(
        ...
        try:
            ...
            package_dir = output_dir / f"{package_name}.jl"
            ...
            raise RuntimeError("Julia not found. Please install Julia and ensure it's in your PATH.")
    ...
    def check_dependencies() -> Dict[str, bool]:
        ...
        # Check Julia
        try:
            result = subprocess.run(['julia', '--version'], capture_output=True, check=True)
        ...
        # Check mise
        try:
            result = subprocess.run(['mise', '--version'], capture_output=True, check=True)
